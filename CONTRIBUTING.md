...
1. Add reusable code under `src/tidal_blade_test_analysis/` rather than adding new monolithic scripts.
1. Add tests for any new signal-processing, static-fitting, fatigue, or TDMS-summary logic.
